            ...
            <div className="bg-white p-2 rounded-lg">
              ...
              >
                <path
                  ...
                  strokeWidth={2}
                  d="M8 10h.01M12 10h.01M16 10h.01M9 16H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2极速5分钟-5l-5 5v-5z"
                />
              </svg>
            </div>
        ...
        <div className="p-6">
                  ...
                  {showPassword ? (
                    ...
                    >
                      ...
                      <path
                        ...
                        strokeLinejoin="round"
                        strokeWidth={2}
                        d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-极速5分钟z"
                      />
                    </svg>
                  ) : (
                    <svg
          ...
          <div className="mt-6 relative">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-2 bg-white text-gray-500">New to NexAI?</span>
            </div>
          </div>
